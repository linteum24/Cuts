...
import 'package:cuts/widgets/loading_view.dart';
...
class ChatPageState extends State<ChatPage> {
  ...
  void readLocal() async {
    ...
    chatProvider.updateDataFirestore(
      Globals.pathUserCollection,
      currentUserId,
      {Globals.chattingWith: peerId},
    );
  }
  ...
  bool isLastMessageLeft(int index) {
    if ((index > 0 &&
            listMessage[index - 1].get(Globals.idFrom) == currentUserId) ||
        index == 0) {
      return true;
    } else {
      return false;
              ...
              Flexible(
                child: Container(
                  child: TextField(
                    ...
                    style: TextStyle(color: Color(0xff203152), fontSize: 15),
